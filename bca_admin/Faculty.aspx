...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server" class="form-horizontal form-label-left">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>MCA Faculties<small>All the present MCA faculties</small></h2>
            ...
            <div class="x_content">
                <asp:Repeater ID="Repeater1" runat="server" DataSourceID="SqlDataSource6">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%# Eval("dob") %></td>
                            <td><%# Eval("exp") %></td>
                            <td><asp:Image ID="Image1" Height="40px" ImageUrl='<%#  Eval("certificate") %>' runat="server" />
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
                ...
                <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [faculty_enroll], [faculty_username], [email], [contact_no], [gender], [dob],[exp],[certificate] FROM [faculty_master]"></asp:SqlDataSource>
                <br />
            </div>
      </div>
 <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [faculty_username], [faculty_id] FROM [faculty_master]"></asp:SqlDataSource>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT DISTINCT [sem] FROM [subject_master]"></asp:SqlDataSource>                      
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [subject_id], [subject] FROM [subject_master] WHERE ([sem] = @sem)">
                            <SelectParameters>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>MCA Faculties & Their Subjects<small>Subjects allocated to the faculties</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li><a class="close-link"><i class="fa fa-close"></i></a>
                    ...
                    <div class="x_content">
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [faculty_id], [faculty_username] FROM [faculty_master]"></asp:SqlDataSource>
                            </div>
                        </div>
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT b.faculty_username, c.subject FROM faculty_subjects_master AS a INNER JOIN faculty_master AS b ON a.faculty_id = b.faculty_id INNER JOIN subject_master AS c ON a.subject_id = c.subject_id WHERE (a.faculty_id = @faculty_id)">
                                <SelectParameters>
