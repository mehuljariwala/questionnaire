...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server" class="form-horizontal form-label-left">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Add Subjects <small>Add new subjects for MCA</small></h2>
            ...
            <div class="x_content">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT DISTINCT [sem] FROM [subject_master] ORDER BY [sem]"></asp:SqlDataSource>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [subject_id], [subject], [sem] FROM [subject_master] WHERE ([sem] = @sem)">
                            <SelectParameters>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT DISTINCT [sem] FROM [subject_master] ORDER BY [sem]"></asp:SqlDataSource>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [subject_id], [subject], [sem] FROM [subject_master] WHERE ([sem] = @sem)">
                                    <SelectParameters>
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [unit_id], [unit_name] FROM [unit_master] WHERE ([subject_id] = @subject_id)">
                                <SelectParameters>                                                                                                                                                                     
