...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server" class="form-horizontal form-label-left">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>MCA Subjects <small>Current MCA Subjects</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li><a class="close-link"><i class="fa fa-close"></i></a>
                ...
                <ContentTemplate>
                    <div class="x_content">
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [subject_id], [subject] FROM [subject_master] WHERE ([sem] = @sem)">
                                <SelectParameters>
