...
public partial class bca_user_exam : System.Web.UI.Page
{
    ...
    {
        x.op();
        qry = "select ques,graphics,option1,option2,option3,option4 from objective_master as a, " + Session["paper"].ToString() + " as b where a.ques_id=b.ques_id and b.ques_no=" + Session["ques_no"].ToString();
        dat = x.sea(qry);
