        ...
        <div id="online-exam-body-div">
            <div class="online-exam-div">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        &nbsp;&nbsp;<asp:Label runat="server" ID="lbl_ques_no" Text="Q1." Font-Size="X-Large" Style="font-family: 'Times New Roman';user-select:none"></asp:Label>
                        &nbsp;<asp:Label ID="lbl_ques" runat="server" Text="How are you?" Font-Size="X-Large" Style="font-family: 'Times New Roman';user-select:none"></asp:Label>
                        <br />
