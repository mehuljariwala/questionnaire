<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="bca_user_Home" %>
...
<body class="header-shadow">
    ...
    <div class="main">
                ...
                <ul>	<!-- SLIDE  -->
                    <li data-index="rs-148" data-transition="fade" data-slotamount="default"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/demo-img-5.jpg"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Welcome" data-description="">
                        ...
                        <div class="tp-caption NotGeneric-SubTitle tp-resizeme rs-parallaxlevel-0"
							...
							<br/>
							Your one stop place for all the exams
                        </div>
       ...
       <section class="content-section">
                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="tab-style-5">
                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                <li role="presentation" class="active"><a href="#home-5" aria-controls="home-5" role="tab" data-toggle="tab"><span class="icon ion-ios-home-outline"></span> Our Vision</a></li>
                            </ul> <!-- end nav-tabs -->

                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="home-5">
                                    <p>Education is to create an environment where young minds nurture to identify their inborn potentials and enhance their entrepreneurial skills to build a better future. One would seek state-of-art learning opportunities at Jain (Deemed-to-be University), India, established by JGI Group, a leading education provider and entrepreneurship incubator for more than 30 years.</p>
                                </div> <!-- end tabpanel -->
        ...
        <section class="content-section grad-bg-10">
            <div class="container">
                <div class="row">
