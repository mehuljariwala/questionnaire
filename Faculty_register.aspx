...
<head runat="server">
    ...
    <!-- ========== META TAGS ========== -->
    <meta name="keywords" content="online exam, MCA online exam">
                ...
                <div class="row pt60 pb60">
                    <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 login-box">
                        ...
                        <form runat="server" name="form1">
                            ...
                            <div class="form-group">
                                <label for="certificate">Please attach certificate if you have :</label>
                                <asp:FileUpload ID="Fcertificate" runat="server" multiple="false" accept="image/jpg/png/pdf" />
                            </div>
                             <div class="form-group">
                                <label for="exp">Year of Experience :</label>
                                <asp:TextBox ID="txt_year_exp" class="form-control" runat="server" placeholder="Enter Year of Experience" MaxLength="2"></asp:TextBox>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" FilterType="Numbers" runat="server" Enabled="True" TargetControlID="txt_year_exp">
                                </asp:FilteredTextBoxExtender>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txt_year_exp"
                                    ErrorMessage="You Must Enter Year of Experience" ForeColor="Red" MaximumValue="99"
                                    MinimumValue="0" Display="Dynamic"></asp:RequiredFieldValidator>
                            </div>
