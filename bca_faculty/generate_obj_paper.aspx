...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server" class="form-horizontal form-label-left">
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>Make Paper <small>Make papers for MCA</small></h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="table-responsive">
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT [unit_name] FROM [unit_master] WHERE ([subject_id] = @subject_id)">
                                        <SelectParameters>
        ...
        <div class="x_panel">
            <div class="x_title">
                <h2>View Paper <small>Generate papers for MCA</small></h2>
                <ul class="nav navbar-right panel_toolbox">
                    <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                    </li>
                    <li><a class="close-link"><i class="fa fa-close"></i></a>
            ...
            <div class="x_content">
                        <div class="form-group">
                            <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" EmptyDataText="No files uploaded" DataSourceID="SqlDataSource2" CssClass="table table-striped jambo_table bulk_action" CellPadding="4" ForeColor="#333333" GridLines="None" >
                                ...
                                <Columns>
                                    <asp:BoundField DataField="id" HeaderText="ID" SortExpression="pdf_id" />
                                    <asp:BoundField DataField="pdf_code" HeaderText="PDF Code" SortExpression="pdf_code" />
                                    <asp:BoundField DataField="subject" HeaderText="Subject" SortExpression="pdf_subject" />
                                    <asp:BoundField DataField="sem" HeaderText="Semester" SortExpression="pdf_sem" />
                                    <asp:BoundField DataField="paper_marks" HeaderText="Total Marks" SortExpression="pdf_marks" />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:online_exam_1ConnectionString %>" SelectCommand="SELECT pdf.id,pdf.pdf_code, sm.subject, sm.sem, pdf.paper_marks FROM pdf_master AS pdf INNER JOIN subject_master AS sm ON pdf.subject_id = sm.subject_id WHERE (pdf.faculty_id = @faculty_id)">
                                    <SelectParameters>
